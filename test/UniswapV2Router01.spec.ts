...
enum RouterVersion {
  ETCswapV2Router01 = 'ETCswapV2Router01',
  ETCswapV2Router02 = 'ETCswapV2Router02'
}

describe('ETCswapV2Router{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.ETCswapV2Router01]: fixture.router01,
        [RouterVersion.ETCswapV2Router02]: fixture.router02
    ...
    describe(routerVersion, () => {
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ETCswapV2Router01]: 101876,
              [RouterVersion.ETCswapV2Router02]: 101898
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
      ...
      describe('swapExactETCForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ETCswapV2Router01]: 138770,
              [RouterVersion.ETCswapV2Router02]: 138770
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
